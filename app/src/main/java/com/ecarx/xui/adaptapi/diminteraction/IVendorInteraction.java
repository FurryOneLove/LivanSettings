...
public interface IVendorInteraction {
    ...
    public interface IVendorInteractionCallback {
        void onInteractionAction(int i, @Nullable IVendorInformation iVendorInformation);
    }
    ...
    boolean updateVendorInformation(@NonNull IVendorInformation iVendorInformation);
}
